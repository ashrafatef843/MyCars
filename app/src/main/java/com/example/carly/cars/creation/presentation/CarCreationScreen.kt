package com.example.carly.cars.creation.presentation
    ...
    with(carCreationViewModel.state) {
        ...
        Column(
            ...
            CenterAlignedTopAppBar(
                ...
                title = {
                    Text(
                        text = stringResource(R.string.title_car_selection),
                        color = Color.White,
                        fontSize = 20.sp,
        ...
        placeholder = {
            Text(
                when (state.creationStep) {
                    is CarCreationStep.BrandStep -> stringResource(R.string.title_search_for_brand)
                    is CarCreationStep.SeriesStep -> stringResource(R.string.title_search_for_series)
                    is CarCreationStep.YearStep -> stringResource(R.string.title_search_for_builder_year)
                    is CarCreationStep.PowerStep -> stringResource(R.string.title_search_for_power_type)
                    else -> ""
                },
                color = White
            )
